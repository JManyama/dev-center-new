...
<h4>Parameters</h4>
<!--<h4 id="get__common_connectionrequests-parameters">Parameters</h4>-->
...
```
<h4>Responses</h4>
<!--<h4 id="get__common_connectionrequests-responses">Responses</h4>-->
...
<h4>Parameters</h4>
<!--<h4 id="post__common_connectionrequests-parameters">Parameters</h4>-->
...
```
<h4>Responses</h4>
<!--<h4 id="post__common_connectionrequests-responses">Responses</h4>-->
...
<h4>Parameters</h4>
<!--<h4 id="get__common_connectionrequests_{id}-parameters">Parameters</h4>-->
...
```
<h4>Responses</h4>
<!--<h4 id="get__common_connectionrequests_{id}-responses">Responses</h4>-->
...
```
<h4>Parameters</h4>
<!--<h4 id="put__common_connectionrequests_{id}-parameters">Parameters</h4>-->
...
<h4>Responses</h4>
<!--<h4 id="put__common_connectionrequests_{id}-responses">Responses</h4>-->
...
<h4>Parameters</h4>
<!--<h4 id="delete__common_connectionrequests_{id}-parameters">Parameters</h4>-->
...
```
<h4>Responses</h4>
<!--<h4 id="delete__common_connectionrequests_{id}-responses">Responses</h4>-->
...
<!---<h4 id="tocS_ConnectionRequestCollection">ConnectionRequestCollection</h4>-->
...
<!--<h4 id="tocS_ConnectionRequestGet">ConnectionRequestGet</h4>-->
...
<!--<h4 id="tocS_ConnectionRequestPut">ConnectionRequestPut</h4>-->
