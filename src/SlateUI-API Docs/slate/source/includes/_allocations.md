...
<h4>Parameters</h4>
<!--<h4 id="get__expense_allocations-parameters">Parameters</h4>-->
...
<h4>Parameters</h4>
<!--<h4 id="get__expense_allocations_{id}-parameters">Parameters</h4>-->
...
```
<h4>Responses</h4>
<!--<h4 id="get__expense_allocations_{id}-responses">Responses</h4>-->
...
### Schemas-Allocations
<!--changed to h3 for deeper nesting-->
